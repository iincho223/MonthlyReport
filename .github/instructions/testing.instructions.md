---
description: "Use when writing or reviewing unit tests, integration tests, or MockMvc tests. Covers test levels, coverage requirements, verification points, and test data rules."
applyTo: "src/test/**"
---
