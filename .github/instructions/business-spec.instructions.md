---
description: "Use when implementing features, reviewing permissions, or checking business constraints. Covers role definitions, visibility scope per role, business rules for reports/escalations/user-management/org-management, deadline rules, and UI/data specs."
---
...
- グループ登録時: GLへ指定するユーザーを必須とする。
- チーム登録時: TLへ指定するユーザーを必須とする。
- 自分自身のアカウントは削除不可。
